  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex w-full items-start px-4 md:px-6 lg:px-8">
        <div className="flex w-full mx-auto min-w-0" style={{ maxWidth: '1400px' }}>
          {/* Left Sidebar - Navigation */}
          <aside className="sticky top-16 z-30 -ml-1 hidden h-[calc(100vh-4rem)] w-56 max-w-56 shrink-0 md:block overflow-y-auto">
          ...
          {/* Main Content Area */}
          <div className="flex-1 flex justify-center md:ml-20 xl:mr-20 min-w-0">
            <div className="w-full max-w-4xl py-3 lg:py-4 min-w-0">
              <main>
          ...
          <aside className="hidden xl:block w-56 max-w-56 shrink-0">
