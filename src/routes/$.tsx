      ...
      <DocsContent>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-2xl mx-auto">
          ...
          <div className="flex gap-3 mb-8">
            <Button asChild className="bg-black text-white hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 [&>a]:text-white dark:[&>a]:text-black [&>a]:no-underline">
              <a href="/">Go Home</a>
            </Button>
